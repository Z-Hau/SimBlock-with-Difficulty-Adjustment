...
public class SimulationConfiguration {
	...
	public static  long AVERAGE_MINING_POWER = 1000000; //400000
	public static final int STDEV_OF_MINING_POWER = 500000;
	...
	public static final int CHANGE_MINING_POWER_INTERVAL = 1000; //1(every block); 0(no changes)
	public static final double MINING_POWER_INCREASE_PERCENTAGE = 0.5; //the chance to increase
	public static final double MINING_POWER_CHANGE_RATIO = 0.3; //how much to increase or decrease
	...
	public static double TOTAL_INTERVAL = 0.0;
