...
public class SimulationConfiguration {
	public static final int NUM_OF_NODES = 100;//600(doge);//800(lite);//6000(bitcoin);
	...
	public static final int ENDBLOCKHEIGHT = 1000; //579972 2019-06-01 12:04 AM - 610638 2020-01-01 00:08 (30666)

	// Unit: byte
	public static final long BLOCKSIZE = 535000;//6110(lite);//8000(doge);//535000(bitcoin);//0.5MB

	public static final int DIFFICULTY_INTERVAL = 100; //readjust difficulty once every N block
	public static int GA_DIFFICULTY_INTERVAL = 100;
