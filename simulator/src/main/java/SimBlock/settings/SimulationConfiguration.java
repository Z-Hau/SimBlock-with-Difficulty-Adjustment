...
public class SimulationConfiguration {
	...
	public static int TOTAL_PREVIOUS_BLOCK_HEIGHT = 0;
	...
	public static int OLD_DIFFICULTY_INTERVAL = 0;
	public static long OLD_INTERVAL = 0L;
	public static int NEW_DIFFICULTY_INTERVAL = 0;
	public static long NEW_INTERVAL = 0L;
	public static boolean GA_TRIGGERED = false;
	public static boolean FIRST_TIME = false;
	public static double  AVERAGE_DIFFICULTY = 0.0;
